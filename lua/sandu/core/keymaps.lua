...
if vim.g.vscode then
  ...
  keymap.set(
    "n",
    "<leader>fsa",
    "<Cmd>call VSCodeNotify('workbench.action.files.saveAll')<CR>",
    { desc = "Save all files" }
  )
  keymap.set(
    "n",
    "<leader>fsn",
    "<Cmd>call VSCodeNotify('workbench.action.files.saveAs')<CR>",
    { desc = "Save file as" }
  )
  ...
  keymap.set(
    "n",
    "<leader>uz",
    "<Cmd>call VSCodeNotify('workbench.action.toggleZenMode')<CR>",
  ...
  keymap.set(
    "n",
    "<leader>oc",
    persistent_term("claude --dangerously-skip-permissions --continue"),
    { desc = "Claude Code (yolo)" }
  )
